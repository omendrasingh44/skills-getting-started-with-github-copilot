...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training and water safety with coached laps",
    ...
    "Drama Club": {
        "description": "Rehearse plays and participate in theatrical performances",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["zara@mergington.edu", "lucas@mergington.edu"]
    },
    "Debate Team": {
        "description": "Prepare for debate competitions with research and public speaking practice",
